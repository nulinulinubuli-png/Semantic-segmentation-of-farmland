...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride, BatchNorm,layer_name = 101, pretrained=True):
        self.inplanes = 64
...
def ResNet50(output_stride, BatchNorm, pretrained=True):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], output_stride, BatchNorm, layer_name=50, pretrained=pretrained)
    return model
